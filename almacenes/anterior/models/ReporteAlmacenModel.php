<?
 	...
 	class ReporteAlmacenModel extends FPDF{
 		private $PG_W = 190;
		private $PG_W1 = 150;
		...
		public function Header() {
			...
			$this->Cell($this->PG_W, 8, "REPORTE DE INGRESOS ALMACEN ", 0, 0, 'C');
			$this->Ln(15);
	...
	public function consulta_detalle(){
		...
		$query_detalle = 'SELECT  alm_cab_ing_egr_nombre AS nombre,
						          ...
						          (SELECT alm_ing_egr_det_cantidad FROM alm_ing_egr_det WHERE alm_ing_egr_det_cod_unico_cab = alm_ing_egr_cab.alm_cab_ing_nro_unico) as cantidad,
						...
						WHERE ISNULL(alm_cab_ing_egr_usr_baja) AND alm_cab_ing_egr_motivo=1 AND alm_cab_ing_egr_fecha_ingreso BETWEEN "'.$fechaInicial.'" AND "'.$fechaFinal.'"   
