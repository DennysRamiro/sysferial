...
//ValidaGrabaCortes
 function ValidaGrabaCortes(formu){
	
	if((formu.difbs.value > 0)){
			//alert("El campo Monto no puede estar vacio.");
			$("#dialog-cortes_bs").dialog({
				height: 140,
             modal: true					
			});
			
		}else if((formu.difbs.value < 0)){
			//alert("El campo Monto no puede estar vacio.");
			$("#dialog-cortes_bs").dialog({
				height: 140,
             modal: true					
			});
	    }else if((formu.difsu.value > 0)){
			//alert("El campo Monto no puede estar vacio.");
			$("#dialog-cortes_su").dialog({
				height: 140,
             modal: true					
			});
	       }else if((formu.difsu.value < 0)){
