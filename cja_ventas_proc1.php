...
$_SESSION['monto_eq'] = 0;
 ...
 <table align="center">
        <tr><th align="left">Cliente :</th><td><input class="txt_campo_cta"  readonly="" value="<?php echo $lin_ven['vent_cab_nom_cotizado']; ?>" /></td></tr>
