...
class ClienteView {
    ...
    public function runIndex(){
        ...
        $template = str_replace('{clasejs}', '', $template);
        ...
        $template = str_replace('{titulo_modulo}', '<h2 style="margin:0px;"><img border="0" align="absmiddle" alt="GEST. VENTAS" src="../img/ventas_64x64.png">GESTION CLIENTES</h2><hr style="border:1px dashed #767676;">', $template);
