...
<div id="pagina_sistema">
        ...
        <ul id="lista_menu">      
          ...
          <h2> <img src="img/flag green_64x64.png" border="0" alt="Modulo" align="absmiddle">REVERTIDO ASIENTO CONTABLE </h2>
               ...
               <?php }?>
			     <?php if ($_SESSION['con_baj'] == 3){?> 
                 <li id="menu_modulo_contabilidad_asientocontable_consultar_sel_modif_rev">
                    
                     <img src="img/back_24x24.png" border="0" alt="Modulo" align="absmiddle"> CAM. FEC. NRO CBTE
                    
                 </li>
                 <li id="menu_modulo_fecha">
                    
                     <img src="img/flag green_24x24.png" border="0" alt="Modulo" align="absmiddle"> CAMBIO FEC. NRO CBTE
                    
                 </li>
              </ul> 
              <div id="contenido_modulo">
          <h2> <img src="img/flag green_64x64.png" border="0" alt="Modulo" align="absmiddle">FECHA CAMBIADA ASIENTO CONTABLE </h2>
                      <hr style="border:1px dashed #767676;">
                       <div id="error_login"> 
                 <img src="img/checkmark_32x32.png" align="absmiddle">
                    El cambio de Fecha del Asiento fue exitoso
                 </div>
               <?php }?>
...
//	}else{
	/* $act_tabla  = "update contab_trans_cli set CONTA_TRS_USR_BAJA = '$logi',
                                        CONTA_TRS_FCH_HR_BAJA = '$hoy'
               where (CONTA_TRS_FEC_VAL between '$fec1' and '$fec1') and
				      CONTA_TRS_NRO = $nro_doc  and
					  CONTA_TRS_EMP = $nitcli and
	                  CONTA_TRS_USR_BAJA is null ";
...
//if( $_SESSION['cargo'] <> 4){
	...
	/*	}else{		
		echo "Aqui";	  
		 $act_tabla  = "update contab_cabec_cli set CONTA_CAB_USR_BAJA = '$logi',
                                        CONTA_CAB_FCH_HR_BAJA = '$hoy'
               where (CONTA_CAB_FEC_TRAN between '$fec1' and '$fec1') and
				      CONTA_CAB_NRO = $nro_doc  and
					  CONTA_CAB_EMP = $nitcli and
	                  CONTA_CAB_USR_BAJA is null ";			  
	} */				  
$res_tabla = mysql_query($act_tabla)or die('No pudo actualizar tabla contab_cabec');
...
$res_tabla = mysql_query($act_tabla);
/*}else{
$act_tabla  = "update contab_trans_cli set CONTA_TRS_FEC_VAL = '$fec_nue_1'
               where  CONTA_TRS_NRO = $nro_doc  and
			    CONTA_TRS_EMP = $nitcli and
	                  CONTA_TRS_USR_BAJA is null ";
$res_tabla = mysql_query($act_tabla);

$act_tabla  = "update contab_cabec_cli set CONTA_CAB_FEC_VAL = '$fec_nue_1',
                                       CONTA_CAB_FEC_TRAN = '$fec_nue_1'
               where  CONTA_CAB_NRO = $nro_doc  and
			          CONTA_CAB_EMP = $nitcli and
	                  CONTA_CAB_USR_BAJA is null ";
...
<center>
     <?php if ($_SESSION['con_baj'] == 2){?> 
  <br><input class="btn_form" type="submit" name="accion" value="Salir Reversion">
    <?php }?>
   <?php if ($_SESSION['con_baj'] == 3){?> 
  <br><input class="btn_form" type="submit" name="accion" value="Salir Cambio de Fecha">
    <?php }?>
  </form>
