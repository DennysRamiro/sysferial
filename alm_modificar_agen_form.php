...
<?php
include("header.php");
$id_agencia=$_GET['id_age'];

        $consulta = "SELECT * 
                     FROM alm_age_adu
                     WHERE alm_age_adu_id='$id_agencia'" or die ('fallo');
...
?>
  ...
  <div id="contenido_modulo">
    ...
    <form name="form2" method="POST" action="alm_acciones_agen.php?tp=modificar&id_agencia=<?php echo $agencia['alm_age_adu_id']?>"  onSubmit="return ValidaCampos_Alta_Aduanera(this)">

      <table align="center">
          <tr>
            <td align="left">C&oacute;digo:</td>
            <td> <input type="text" id="cod" name="cod" class="txt_campo" value="<?php echo $agencia['alm_age_adu_cod'];?>"><div id="error_cod"></div></td>
           </tr>
           <tr>
