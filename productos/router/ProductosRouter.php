...
//mod Nela			
		...
		case 'cargardetalleProducto':
					...
					//echo "VACIO";				
						...
						$json_data['alm_prod_det_prec_lic_local']= '';
						$json_data['alm_prod_det_prec_lic_interior']= '';
				    ...
				    print_r(json_encode($array));
						...
						foreach($det_prod as $key => $value){
							...
							$json_data['alm_prod_det_prec_lic_local']= $value['alm_prod_detalle']['alm_prod_det_prec_lic_local'];
						    $json_data['alm_prod_det_prec_lic_interior']= $value['alm_prod_detalle']['alm_prod_det_prec_lic_interior'];
