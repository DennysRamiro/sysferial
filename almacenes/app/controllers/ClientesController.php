        ...
        switch ($tp) {
            ...
            case "buscarClienteVenta":
                ...
                if(!empty($list_clientes)){
                    ...
                    foreach($list_clientes as $key =>$value){
                        $json_data['id']    = $value['vent_cliente']['vent_cli_cod_unico'];
                        $json_data['label'] = $value['vent_cliente']['vent_cli_codigo_cliente']." ".$value['vent_cliente']['vent_cli_nombre']." ".$value['vent_cliente']['vent_cli_apellido_pat']." ".$value['vent_cliente']['vent_cli_nit'];
                        $json_data['value'] = $value['vent_cliente']['vent_cli_nombre']." ".$value['vent_cliente']['vent_cli_apellido_pat']." ".$value['vent_cliente']['vent_cli_apellido_mat'];
                        $array[$cont] = $json_data; 
                        $cont++;
                    }
                    ...
                    $json_data['id']    = '';
                    $json_data['label'] = 'Por favor intente con otro nombre '.$_GET['buscar_palabra'];
                    $json_data['value'] = '';
                    $array[0] = $json_data;
                }
                print(json_encode($array));   
