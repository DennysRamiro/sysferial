...
<table width="100%"  border="1" cellspacing="1" cellpadding="1" align="left">
    <tr>
	  ...
	  <td width="10%" scope="col" style="font-size:10px" align="center"><border="0" alt="" align="absmiddle" />TIP.TRANS.</th>
	  <td width="30%" scope="col" style="font-size:10px" align="center" ><border="0" alt="" align="absmiddle" />DETALLES</th>
	  <td width="10%" scope="col" style="font-size:10px" align="center"><border="0" alt="" align="absmiddle" />INGRESOS Bs.</th>
      <td width="10%" scope="col" style="font-size:10px" align="center"  ><border="0" alt="" align="absmiddle" />EGRESOS Bs.</th>
	  <td width="10%" scope="col" style="font-size:10px" align="center"><border="0" alt="" align="absmiddle" />SALDO Bs.</th>
	  <td width="10%" scope="col" style="font-size:10px" align="center"><border="0" alt="" align="absmiddle" />INGRESOS $us.</th>
      <td width="10%" scope="col" style="font-size:10px" align="center" ><border="0" alt="" align="absmiddle" />EGRESOS $us.</th>
	  <td width="10%" scope="col" style="font-size:10px" align="center"><border="0" alt="" align="absmiddle" />SALDO $us.</th>
