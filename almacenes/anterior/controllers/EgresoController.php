     ...
     */
        ...
        public function runIndex($accion){
             ...
             case 'buscarEgresos':
              ...
              case 'buscarNotasEgr':
                    ...
                    foreach ($lista_not_egr as $key => $value) {   
                      ...
                      $json_data['alm_cab_ing_egr_motivo_registro']= $value['cab']['alm_cab_ing_egr_motivo_registro'];
                      ...
                      $json_data['GRAL_AGENCIA_SIGLA_O']= $value['orig']['GRAL_AGENCIA_SIGLA'];            
                      $json_data['GRAL_AGENCIA_NOMBRE_O']= $value['orig']['GRAL_AGENCIA_NOMBRE'];
                      $json_data['GRAL_AGENCIA_DIRECCION_O']= $value['orig']['GRAL_AGENCIA_DIRECCION'];

                      $json_data['GRAL_AGENCIA_SIGLA_D']= $value['dest']['GRAL_AGENCIA_SIGLA'];            
                      $json_data['GRAL_AGENCIA_NOMBRE_D']= $value['dest']['GRAL_AGENCIA_NOMBRE'];
                      $json_data['GRAL_AGENCIA_DIRECCION_D']= $value['dest']['GRAL_AGENCIA_DIRECCION'];
            ...
            case 'getDatosBusNotEgr':
              $datos_not_egr=$egreso_model->getDatosBusEgr($_GET['id_unico'],2);
...
*/
             ...
             case 'getDataCabeceraDetalle':
              ...
              case 'getNota':
              	//print_r($_GET['unico']);
              	$nota = $egreso_model->getNotaEgreso($_GET['unico']);
                  ...
                  if (empty($nota)) {
                     ...
                     foreach ($nota as $key => $value) {
                        ...
                        $json_data['fila']=$fila;
  		                  ...
  		                  $json_data['alm_cab_ing_egr_nro_nota']=$value['c']['alm_cab_ing_egr_nro_nota'];
  		                  $json_data['alm_cab_ing_egr_nombre']=$value['c']['alm_cab_ing_egr_nombre'];
  		                  $json_data['alm_cab_ing_egr_fecha_ingreso']=$util->cambiaf_a_normal($value['c']['alm_cab_ing_egr_fecha_ingreso']);
  		                  $json_data['alm_cab_ing_egr_origen']=$value['c']['alm_cab_ing_egr_origen'];
  		                  $json_data['alm_cab_ing_egr_destino']=$value['c']['alm_cab_ing_egr_destino'];
  		                  $json_data['alm_cab_ing_egr_motivo']=$value['c']['alm_cab_ing_egr_motivo'];
                        ...
                        $json_data['GRAL_AGENCIA_CODIGO_D'] = $value['gad']['GRAL_AGENCIA_CODIGO'];
                        $json_data['GRAL_AGENCIA_SIGLA_D'] = $value['gad']['GRAL_AGENCIA_SIGLA'];
                        $json_data['GRAL_AGENCIA_NOMBRE_D'] = $value['gad']['GRAL_AGENCIA_NOMBRE'];
                        $json_data['GRAL_AGENCIA_DIRECCION_D'] = $value['gad']['GRAL_AGENCIA_DIRECCION'];
                        $json_data['GRAL_AGENCIA_FONO1_D'] = $value['gad']['GRAL_AGENCIA_FONO1'];
                        $json_data['GRAL_AGENCIA_FONO2_D'] = $value['gad']['GRAL_AGENCIA_FONO2'];
                        $json_data['GRAL_AGENCIA_EMAIL_D'] = $value['gad']['GRAL_AGENCIA_EMAIL'];

                        $json_data['GRAL_AGENCIA_CODIGO_O'] = $value['gao']['GRAL_AGENCIA_CODIGO'];
                        $json_data['GRAL_AGENCIA_SIGLA_O'] = $value['gao']['GRAL_AGENCIA_SIGLA'];
                        $json_data['GRAL_AGENCIA_NOMBRE_O'] = $value['gao']['GRAL_AGENCIA_NOMBRE'];
                        $json_data['GRAL_AGENCIA_DIRECCION_O'] = $value['gao']['GRAL_AGENCIA_DIRECCION'];
                        $json_data['GRAL_AGENCIA_FONO1_O'] = $value['gao']['GRAL_AGENCIA_FONO1'];
                        $json_data['GRAL_AGENCIA_FONO2_O'] = $value['gao']['GRAL_AGENCIA_FONO2'];
                        $json_data['GRAL_AGENCIA_EMAIL_O'] = $value['gao']['GRAL_AGENCIA_EMAIL'];
 ...
 /**/
                  ...
                  case 'optenerProductoSeleccionado':
                      $datos_producto_seleccionado = $egreso_model->optenerProductoSelecionado($_GET);
                      ...
                      $unidad = $egreso_model->getUnidadXId($datos_producto_seleccionado[0]['apc']['alm_prod_cab_unidad']);
