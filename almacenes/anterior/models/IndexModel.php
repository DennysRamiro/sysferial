<?php
  ...
  require_once 'ControlInventarioPEPS.php';
	/**
	 *
	 */
	class IndexModel{
    ...
    /*
     * Este es el metodo que devuelve los tipos de ingreso
     * 
     */
    public function getTipoIngreso(){
        $consulta  = "SELECT GRAL_PAR_PRO_ID, GRAL_PAR_PRO_SIGLA, GRAL_PAR_PRO_DESC, GRAL_PAR_PRO_GRP 
                      FROM gral_param_propios WHERE GRAL_PAR_PRO_GRP=2500";
        return $this->mysql->query($consulta);
    }
    ...
    public function guardarNuevoIngreso($datos){
     //print_r($datos);
      ...
      $valores['alm_cab_ing_egr_descripcion']=$datos['alm_ing_descr'];
      $valores['alm_cab_ing_egr_tipo_ingreso']=$datos['ingr_tipo_ingreso'];
