...
//echo $_POST['fec_nac'];
  ...
  // if( $_SESSION['cargo'] <> 4){
	...
	//	 }else{	
		//  $consulta  = "Select CONTA_CAB_NRO,CONTA_CAB_GLOSA
	     //         From contab_cabec_cli where CONTA_CAB_EMP = $nitcli and CONTA_CAB_NRO = $nro_doc and
		//		  CONTA_CAB_FEC_TRAN = '$fecha' and CONTA_CAB_USR_BAJA is null group by 
		//		  CONTA_CAB_NRO,CONTA_CAB_GLOSA order by CONTA_CAB_NRO ";
	...
	/*  }else{
	     $consulta  = "Select CONTA_CAB_NRO,CONTA_CAB_GLOSA, CONTA_CAB_FEC_TRAN
	              From contab_cabec_cli where CONTA_CAB_EMP = $nitcli and
				 CONTA_CAB_FEC_TRAN = '$fecha' and CONTA_CAB_USR_BAJA is null group by 
				  CONTA_CAB_NRO,CONTA_CAB_GLOSA order by CONTA_CAB_NRO ";
 ...
 ?>
  ...
  <?php
	  ...
	  <font size="-1">
			  ...
			  <input class="btn_form" type="submit" name="accion" value="Cambiar Fecha">
